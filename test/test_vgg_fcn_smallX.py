...
from vgg_fcn import fcn8_vgg, vgg_fcn_small, vgg_fcn_smallX
import os
...
result_dir = '../test_output/vgg_smallX_epoch100'
...
with tf.Session() as sess:
    ...
    vgg_smallX = vgg_fcn_smallX.VGG_FCN_SMALL(vgg16_npy_path='../vgg16.npy')
    with tf.name_scope("content_vgg"):
        vgg_smallX.build(batch_images)
